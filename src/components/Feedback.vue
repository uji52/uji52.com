  ...
  <div class="developer-page">
    <section name="head" class="section section-shaped section-lg my-0">
      ...
      <div class="container shifted">
        <h1 class="display-5 fw-bold text-body-emphasis text-center">機能要望等</h1>
      </div>
    </section>
    <section name="head" class="section section-shaped section-lg my-0">
      <div class="shape shape-style-1 shape-default shape-skew"></div>
      <div class="container shifted">
        <form @submit.prevent="submitFeedback" class="feedback-form">
          ...
          <div class="form-group">
            ...
            <input type="email" id="email" v-model="email" class="col-md-3 mb-3">
          </div>
          <div class="form-group">
            <label for="message" class="col-md-6 mb-6">(必須)Message</label>
            <textarea id="message" v-model="message" required class="col-md-3 mb-3"></textarea>
          </div>
          <div class="form-group">
...
const submitFeedback = async () => {
  const response = await fetch('https://api.uji52.com/email', {
    method: 'POST',
    headers: {
